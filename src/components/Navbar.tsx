...
import { Menu, Zap, TreePalmIcon as PalmTree } from "lucide-react"
...
export default function Navbar() {
 ...
 className="flex-shrink-0">
                        ...
                        {menuItems.map((item) => (
                            ...
                            >
                                ...
                                {item.submenu && activeSubmenu === item.title && (
                                    <div
                                        className="absolute top-full left-0 w-[800px] bg-white rounded-3xl shadow-lg p-6 mt-2"
                    ...
                    <Sheet open={isOpen} onOpenChange={setIsOpen}>
                        ...
                        <SheetContent side="right" className="w-[80%] rounded-l-[2rem]">
                            <SheetHeader>
